    ...
    public static class TestData
    {
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            new Section { Id = 1, Name = "Спорт", Order = 0 },
              ...
              new Section { Id = 19, Name = "_Fendi", Order = 0, ParentId = 18 },
              new Section { Id = 20, Name = "_Guess", Order = 1, ParentId = 18 },
              new Section { Id = 21, Name = "_Valentino", Order = 2, ParentId = 18 },
